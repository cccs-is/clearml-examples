...
task = Task.init(project_name='ar2c testing', task_name='PyTorch with Matplotlib example', task_type=Task.TaskTypes.testing)
...
style_img = image_loader(os.path.join("data_samples", "picasso.jpg"))
content_img = image_loader(os.path.join("data_samples", "dancing.jpg"))
